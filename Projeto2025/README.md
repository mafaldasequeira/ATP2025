...
def simula_interface(params):
    ...
    while tempo_atual < TEMPO_SIMULACAO:
        doente_id = "p" + str(contadorDoentes) 
        contadorDoentes += 1
        ...
        if e_tipo(evento) == CHEGADA:
            ...
            if medico_index != -1:   
                ...
                if melhor_doente_id != -1:
                    ...
                    prox_doente_id = queue[melhor_doente_id][0]  
                    queue = queue[:melhor_doente_id] + queue[melhor_doente_id+1:]  
